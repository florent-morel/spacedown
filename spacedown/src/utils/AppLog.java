...
public class AppLog {
	...
	private static void log(Context context, int loggingLevel, String message) {
		...
		String appDir = Environment.getExternalStorageDirectory().getAbsolutePath() + Constants.SLASH + Constants.APP_NAME;
		...
		File logFile = new File(appDir + Constants.SLASH + Constants.PATH_LOGS + Constants.SLASH + fileName);

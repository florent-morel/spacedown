package org.spacedown.activity.create;

import org.spacedown.R;
import org.spacedown.SpacedownApp;
import org.spacedown.database.PlayersDataSource;
...
public class AddPlayer extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		app = ((SpacedownApp) getApplicationContext());
		...
		if (playerId != 0) {
			...
			Uri playerUri = ContentUris.withAppendedId(SpacedownContentProvider.CONTENT_URI_PLAYERS, playerId);

...
public class SpacedownContentProvider extends ContentProvider {

	private static final String TAG = SpacedownContentProvider.class.getSimpleName();

	public static final String ROOT_PACKAGE = "org.spacedown";
